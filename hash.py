...
def banner():
	...
	print (Y+"\n 0{==================================================}0")
	print (Y+" | "+G+"   __ __         __             "+R+"Hash Cracker "+W+"2.3"+Y+"   |")
	print (Y+" | "+G+"  / // /__  ___ / /  ___ ____  "+Y+"                    |")
	print (Y+" | "+G+" / _  / _ `(_-</ _ \/ -_) __/  "+B+"["+W+"="+B+"]"+W+" Author : Ci Ku"+Y+"  |")
	print (Y+" | "+G+"/_//_/\_,_/___/_//_/\__/_/     "+B+"["+W+"="+B+"] "+W+"I'M ALONE :("+Y+"    |")
	print (Y+" |                                                    |")
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version  "+C+":"+W+" 2.3.1"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" Ci Ku"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" XnVer404@gmail.com"+Y+"                  |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Facebook "+C+":"+W+" https://facebook.com/ci.ku.370"+Y+"      |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 23 - 02 - 2018"+Y+"                      |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+" no team, I'm alone"+C+"          \(T_T)/"+Y+" |")
	print (Y+" 0{==================================================}0\n")
